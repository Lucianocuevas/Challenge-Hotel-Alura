...
public class RegistroHuesped extends JFrame {
	...
	private String msg;
	//private int key = evt.getKeyChar();
	...
	public RegistroHuesped(int id) {
		...
		txtTelefono.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
		        ...
		        if (!(numeros || borrar || supr)) {
		        	Mensaje("<html><b>Solo numeros</b></html>");
		        	e.consume();
		        }
			}
		});
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(txtFechaN.getDate() == null) {
					...
					cliente.put("Fecha N", txtFechaN.getDate().toString());
					cliente.put("Nacionalidad", txtNacionalidad.getSelectedItem().toString());
					cliente.put("Telefono", txtTelefono.getText());
					
					if(cliente.containsValue("")){
		...
		labelGuardar.setFont(new Font("Roboto Medium", Font.PLAIN, 20));
	...
	protected void GuardarHuesped() {
		Date fechaN = new Date(txtFechaN.getDate().getTime());		
			Huesped huesped = new Huesped( 
					txtNombre.getText(), txtApellido.getText(), 
					fechaN,txtNacionalidad.getSelectedItem().toString(),
