...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		btnAtras.setBackground(Color.WHITE);
		btnAtras.setBounds(238, 493, 53, 36);
		header.add(btnAtras);
			...
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					if(txtFechaEntrada.getDate().compareTo(txtFechaSalida.getDate()) < 0) {						
						...
						Mensaje("La fecha de Salida no puede ser mayor a la entrada");
					}					
				}
			}			
		});
		...
		txtFormaPago.setModel(new DefaultComboBoxModel(new String[] {"Tarjeta de Crédito", 
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					...
					if(txtFechaEntrada.getDate().compareTo(txtFechaSalida.getDate()) < 0) {
						...
						var reserva = new Reserva(fechaEntrada, fechaSalida, 
						txtFormaPago.getSelectedItem().toString(), valor);
						id = (reservaController.guardar(reserva));
						reserva.setId(id);
						
						Mensaje("<html>¡Reserva: <b>" + id + "</b> guardada con exito!</html>");
		...
		btnsiguiente.setBounds(256, 494, 122, 35);
		...
		lblSiguiente.setForeground(new Color(255, 255, 255));
		lblSiguiente.setHorizontalAlignment(SwingConstants.CENTER);
		lblSiguiente.setFont(new Font("Roboto Medium", Font.PLAIN, 20));
	...
	private void Calcular() {
			...
			fechaEntrada =  new java.sql.Date(txtFechaEntrada.getDate().getTime()) ;
			fechaSalida = new java.sql.Date(txtFechaSalida.getDate().getTime());
